...
func (w Walking) Calories() float64 {
	// вставьте ваш код ниже
	meanSpeedMinH := w.meanSpeed() * KmHInMsec
	return (CaloriesWeightMultiplier*w.Weight + (math.Pow(meanSpeedMinH, 2)/(w.Height/CmInM))*CaloriesSpeedHeightMultiplier*w.Weight) * w.Duration.Hours() * MinInHours
}
